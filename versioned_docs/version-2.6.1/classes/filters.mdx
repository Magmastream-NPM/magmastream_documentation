...
> | ------------------------------------------ | :-------------------------------------- | :-------------------------------------- |
> | `filter`                                   | [`AvailableFilters`](#availablefilters) | <i className="fa-solid fa-xmark"/>          |
...
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type          | <i className="fa-solid fa-flask"/> Optional |
> | ------------------------------------------ | :------------------------------------------ | :-------------------------------------- |
> | `distortion`                               | [`DistortionOptions{}`](#distortionoptions) | <i className="fa-solid fa-xmark"/>          |
...
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type | <i className="fa-solid fa-flask"/> Optional |
> | ------------------------------------------ | :--------------------------------- | :-------------------------------------- |
> | `bands`                                    | [`Band[]`](../typedefs/band.md)    | <i className="fa-solid fa-xmark"/>          |
...
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type    | <i className="fa-solid fa-flask"/> Optional |
> | ------------------------------------------ | :------------------------------------ | :-------------------------------------- |
> | `karaoke`                                  | [`KaraokeOptions{}`](#karaokeoptions) | <i className="fa-solid fa-xmark"/>          |
...
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type        | <i className="fa-solid fa-flask"/> Optional |
> | ------------------------------------------ | :---------------------------------------- | :-------------------------------------- |
> | `timescale`                                | [`TimescaleOptions{}`](#timescaleoptions) | <i className="fa-solid fa-xmark"/>          |
...
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type    | <i className="fa-solid fa-flask"/> Optional |
> | ------------------------------------------ | :------------------------------------ | :-------------------------------------- |
> | `vibrato`                                  | [`VibratoOptions{}`](#vibratooptions) | <i className="fa-solid fa-xmark"/>          |
...
>
> | <i className="fa-solid fa-pen"/> Properties | <i className="fa-solid fa-font"/> Type | <i className="fa-solid fa-list"/> Description                  |
> | --------------------------------------- | :--------------------------------- | :--------------------------------------------------------- |
