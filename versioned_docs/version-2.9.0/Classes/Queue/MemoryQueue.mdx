...
description: The MemoryQueue class represents a queue.
slug: /class/queue/MemoryQueue
sidebar_label: MemoryQueue
sidebar_position: 0
---
...
> |:------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------|
> | `current`                                 | [`Track`](../../Typedefs/Track.mdx) \| [null](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Null)           | The current track.                            |
> | `guildId`                                 | [string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)                                              | The guild ID.                                 |
> | `manager`                                 | [`Manager`](../Manager.mdx)                                                                                                                    | The Manager instance.                         |
> | `previous`                                | [`Track[]`](../../Typedefs/Track.mdx) \| [\[\]](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array) | The previous tracks.                          |
