...
sidebar_position: 2
sidebar_label: 🐍 Changes in 2.9.0
---
...
> - **autoPlaySearchPlatform** → `autoPlaySearchPlatforms` (array of [`AutoPlayPlatform`](./Enums/AutoPlayPlatform.mdx))
...
>  - [`LyricsLine`](./Typedefs/ManagerEvents/LyricsEvents#lyricsline)
>  - [`LyricsNotFound`](./Typedefs/ManagerEvents/LyricsEvents#lyricsnotfound)
...
> ## Backup Node Support
> Check [`NodeOptions`](./Typedefs/NodeOptions.mdx) (`isBackup`, default ➔ `false`).
