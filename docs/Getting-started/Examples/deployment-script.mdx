...
:::::tip
💡 This page requires you to have a valid [main file](/docs/getting-started/examples/main-file), have at least created `one` command following [these steps](/docs/getting-started/examples/creating-commands) and followed the last two steps [command handling](/docs/getting-started/examples/command-handling) and [event handling](/docs/getting-started/examples/event-handling).
:::info
