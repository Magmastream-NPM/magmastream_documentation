...
## Resulting code
If you want to compare your code to the code we've constructed so far, you can review it over on the GitHub repository [here](https://github.com/Magmastream-NPM/magmastream_basics_bot/tree/basic_js/src/commands/music) .