...
:::info
ℹ️ This section can be done for both `slash-commands` and `message-commands`, as [`Client#messageCreate`](https://discord.js.org/docs/packages/discord.js/main/Client:Class#messageCreate)<i className="fa-solid fa-arrow-up-right-from-square" style={{ fontSize: '0.6em'}}/> as message-commands are executed from within the [`Client#messageCreate`](https://discord.js.org/docs/packages/discord.js/main/Client:Class#messageCreate)<i className="fa-solid fa-arrow-up-right-from-square" style={{ fontSize: '0.6em'}}/> event.
:::
:::::
...
If you want to make sure, you have the exact code for the `index.js` file, you can review it on the GitHub repository [here <i className="fa-solid fa-arrow-up-right-from-square" style={{ fontSize: '0.6em'}}/>](https://github.com/Magmastream-NPM/magmastream_basics_bot/blob/basic_js/src/index.js).
...
if you want to make sure, you have the exact code for the different events etc. take a look at the example  GitHub repository [here <i className="fa-solid fa-arrow-up-right-from-square" style={{ fontSize: '0.6em'}}/>](https://github.com/Magmastream-NPM/magmastream_basics_bot/tree/basic_js/src).
## Next steps
