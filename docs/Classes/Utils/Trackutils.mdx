...
> | `requester`                                    | [`User`](https://discordjs.dev/docs/packages/discord.js/main/User:Class) \| [`ClientUser`](https://discordjs.dev/docs/packages/discord.js/main/ClientUser:Class) | The requester.                                | <i className="fa-solid fa-xmark"/>          |
> 
> #### Returns
