---
id: queue-json
title: "Class: JsonQueue"
description: The JsonQueue class represents a queue.
slug: /class/queue/JsonQueue
sidebar_label: JsonQueue
---
...
## Class Definition
```ts
export class JsonQueue extends Array<Track> implements IQueue {}
```
...
> | `previous`                                | [`Track[]`](../../Typedefs/Track.mdx) \| []                                                                                          | The previous tracks.                          |
