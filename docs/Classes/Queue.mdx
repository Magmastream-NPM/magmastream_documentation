...
> The current track
>
> Return: [`Track`](../Typedefs/Track/trackOptions.mdx#trackOptions) \| [`UnresolvedTrack`](../Typedefs/Track/unresolvedTrack.mdx#unresolvedTrack) | [null](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Null)
...
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type                                                                                                                                                                             | <i className="fa-solid fa-list"/> Description                                                             |
> | :--------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------- |
> | `track`                                        | ([`Track`](../Typedefs/Track/trackOptions.mdx#trackOptions) \| [`UnresolvedTrack`](../Typedefs/Track/unresolvedTrack.mdx#unresolvedTrack)) \| ([`Track`](../Typedefs/Track/trackOptions.mdx#trackOptions) \| [`UnresolvedTrack`](../Typedefs/Track/unresolvedTrack.mdx#unresolvedTrack))[] | The track or tracks to add. Can be a single `Track` or an array of `Track`s.                              |
...
>
> Return: ([`Track`](../Typedefs/Track/trackOptions.mdx#trackOptions) \| [`UnresolvedTrack`](../Typedefs/Track/unresolvedTrack.mdx#unresolvedTrack))[]
>
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type                                                            | <i className="fa-solid fa-list"/> Description                                                                                                                                                      |
> | :--------------------------------------------- | :------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type   | <i className="fa-solid fa-list"/> Description                                                                                      |
> | :--------------------------------------------- | :--------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------- |
> | `bands`                                        | [`Band[]`] | The equalizer bands to apply. Each band includes a band number and a gain value. If no bands are provided, the equalizer is reset. |
