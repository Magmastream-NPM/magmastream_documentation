...
<Tabs>
    <TabItem value="node" label="Node : options" default>
        ...
        | `sessionTimeoutSeconds`                        | [number](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number)   | The time the lavalink server will wait before it removes the player. |     <i className="fa-solid fa-check"/>      |
