...
> | :----------------------------------------------|:----------------------------------------------|
> | Promise\<[`LavalinkInfo`](../Typedefs/LavalinkInfo.mdx)> | The node info.                                |
...
> | <i className="fa-solid fa-arrow-right"/> Type                                                  | <i className="fa-solid fa-list"/> Description |
> | :----------------------------------------------------------------------------------------------|:----------------------------------------------|
> | Promise\<[`Lyrics`](../Typedefs/Lyrics.mdx) \| [`NodeLinkGetLyrics`](../Typedefs/NodeLinkGetLyrics.mdx)> | The lyrics.                                   |
...
> | <i className="fa-solid fa-arrow-right"/> Type               | <i className="fa-solid fa-list"/> Description |
> | :-----------------------------------------------------------|:----------------------------------------------|
> | Promise\<[`SponsorBlockSegment[]`](../Enums/SponsorBlockSegment.mdx)> | The sponsor block.                            |
