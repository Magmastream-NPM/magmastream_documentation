...
> | `nodes`                                   | Collection\<[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String), [`Node`](./Node.mdx)\>                                                          | The nodes.                                    |
> | `options`                                 | [`ManagerOptions`](../Typedefs/ManagerOptions.mdx)                                                    | The manager options.                          |
> | `players`                                 | Collection\<[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String), [`Player>`](./Player.mdx)\>                                                          | The players.                                  |
...
> | <i className="fa-solid fa-arrow-right "/> Type  | <i className="fa-solid fa-list "/> Description |
> | :-----------------------------------------------|:-----------------------------------------------|
> | Promise\<[`TrackData`](../Typedefs/TrackData.mdx)>        | The decoded track.                             |
...
> | <i className="fa-solid fa-arrow-right "/> Type | <i className="fa-solid fa-list "/> Description |
> | :----------------------------------------------|:-----------------------------------------------|
> | Promise\<[`TrackData[]`](../Typedefs/TrackData.mdx)>     | The decoded tracks.                            |
...
> | <i className="fa-solid fa-arrow-right "/> Type  | <i className="fa-solid fa-list "/> Description |
> | :-----------------------------------------------|:-----------------------------------------------|
> | [`Player`](./Player.mdx) \| [undefined](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Undefined)         | The player.                                    |
...
> | <i className="fa-solid fa-arrow-right "/> Type | <i className="fa-solid fa-list "/> Description |
> | :----------------------------------------------|:-----------------------------------------------|
> | Promise\<[`this`](./Manager.mdx#properties)>                     | The manager.                                   |
...
> | `requester`                                     | T = unknown                                      | The requester.                                 | <i className="fa-solid fa-xmark "/>          |
...
> | <i className="fa-solid fa-hashtag "/> Parameter | <i className="fa-solid fa-font "/> Type                                                                   | <i className="fa-solid fa-list "/> Description | <i className="fa-solid fa-flask "/> Optional |
> | :-----------------------------------------------|:----------------------------------------------------------------------------------------------------------| :----------------------------------------------| :-------------------------------------------:|
> | `user`                                        | [`PortableUser`](../Typedefs/PortableUser.mdx) \| [string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String) | The packet.                                    | <i className="fa-solid fa-xmark "/>          |
