...
<Tabs>
    <TabItem value="manager" label="Manager : options" default>
        ...
        | `nodes`                                    | [`Node[]`](../Typedefs/Node/Node.mdx#nodeOptions)                                                                                                                                                           | The array of nodes to connect to.                                                                                                                                                 |
...
|                                             | [useableNodes()](#useablenodes)                    | [playerMove](#playermove)                      |
...
> The map of players.
>
> Return: [Collection](https://discord.js.org/docs/packages/collection/main/Collection:class)\<[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String), [`Player`](./Player.mdx)>
...
> The map of nodes.
>
> Return: [Collection](https://discord.js.org/docs/packages/collection/main/Collection:class)\<[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String), [`Node`](./Node.mdx)>
...
>
> Return: [ManagerOptions](#constructor)
...
>
> Return: [`Player`](./Player.mdx)
>
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type                    | <i className="fa-solid fa-list"/> Description |
> | :--------------------------------------------- | :-------------------------------------------------------- | :-------------------------------------------- |
> | `options`                                      | [`playerOptions{}`](../Typedefs/Player.mdx#playeroptions) | The options to create the player with.        |

### createNode()

> Creates a new node or returns an existing one if it already exists.
>
> Return: [`Node`](../Classes/Node.mdx)
>
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type              | <i className="fa-solid fa-list"/> Description |
> | :--------------------------------------------- | :-------------------------------------------------- | :-------------------------------------------- |
> | `options`                                      | [`nodeOptions{}`](../Typedefs/Node/Node.mdx#nodeOptions) | The options to create the node with.          |

### decodeTrack()

> Decodes a base64 encoded track and returns a TrackData.
>
> Return: [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)[\<`trackData{}`>](../Typedefs/Track.mdx#trackdata)
>
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type                                                                                                                                  | <i className="fa-solid fa-list"/> Description |
> | :--------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------- |
...
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type                                                                                                         | <i className="fa-solid fa-list"/> Description             |
> | :--------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------- |
> | `nodeId`                                       | [string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String) as [node identifier](./Node.mdx) | The ID of the node to load player states from (required). |

### get()

> Returns a player or undefined if it does not exist.
>
> Return: [`Player`](./Player.mdx) | [undefined](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Undefined)
>
> | <i className="fa-solid fa-hashtag"/> Parameter | <i className="fa-solid fa-font"/> Type                                                                                                                                                 | <i className="fa-solid fa-list"/> Description |
> | :--------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------- |
...
> | `payload`                                      | [`SponsorBlockChapterStarted{}`](../Typedefs/SponsorBlock.mdx#sponsorblockchapterstarted)                |
...
> | `player`                                       | [`Player`](./Player.mdx)                                                                                 |
> | `track`                                        | [`Track{}`](../Typedefs/Track.mdx#track) \| [`UnresolvedTrack{}`](../Typedefs/Track.mdx#unresolvedtrack) |
> | `payload`                                      | [`SponsorBlockChaptersLoaded{}`](../Typedefs/SponsorBlock.mdx#sponsorblockchaptersloaded)                |
...
> | `changeType`                                   | [`PlayerStateUpdateEvent{}`](../Typedefs/Player.mdx#playerStateUpdate) |
...
> | `payload`                                      | [`SponsorBlockSegmentSkipped{}`](../Typedefs/SponsorBlock.mdx#sponsorblocksegmentskipped)          |
...
> | `player`                                       | [`Player`](./Player.mdx)                                                                           |
> | `track`                                        | [`Track{}`](../Typedefs/Track.mdx) \| [`UnresolvedTrack{}`](../Typedefs/Track.mdx#unresolvedtrack) |
> | `payload`                                      | [`SponsorBlockSegmentsLoaded{}`](../Typedefs/SponsorBlock.mdx#sponsorblocksegmentsloaded)          |
