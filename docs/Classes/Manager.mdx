...
<Tabs>
    <TabItem value="manager" label="ManagerOptions" default>
        ```js
        ...
        > | `enabledPlugins`                                     | [`Plugin[]`](./Plugin.mdx)                                                                              | List of plugins to enable.                                                                       | <i className="fa-solid fa-check"/>          |
        ...
        > | `enablePriorityMode`                                 | [boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean)     | Enable priority mode over least-load balancing.                                                  | <i className="fa-solid fa-check"/>          |
        ...
        > | [`send`](#send)                                               | [function](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)   | Function used to send data to Discord’s WebSocket gateway.                                       | <i className="fa-solid fa-xmark"/>          |
