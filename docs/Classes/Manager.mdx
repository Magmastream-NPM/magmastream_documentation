...
<Tabs>
    <TabItem value="manager" label="Manager : options" default>
        ...
        |:-----------------------------------------------|:------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------- |:-------------------------------------------:|
        | `playNextOnEnd`                                | [boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean)   | Automatically play the next track when the current one ends.                                 |     <i className="fa-solid fa-check"/>      |
        | `autoPlaySearchPlatforms`                      | [ `AutoPlayPlatform[]`](../Enums/AutoPlayPlatform.mdx)                                                | An array of search platforms to use for autoplay. First to last matters.                     |     <i className="fa-solid fa-check"/>      |
        ...
        | `clusterId`                                    | [number](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number)     | The number of the cluster this manager instance is connected to.                             |     <i className="fa-solid fa-check"/>      |
        | `defaultSearchPlatform`                        | [<i className="fa-solid fa-bars-staggered" /> SearchPlatform](../Enums/SearchPlatform.mdx)            | The default search platform to use. Defaults to ytsearch.                                    |     <i className="fa-solid fa-check"/>      |
        | `lastFmApiKey`                                 | [string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)     | The last.fm API key used for Autoplay. Get it from [here](https://www.last.fm/api/accounts). |     <i className="fa-solid fa-check"/>      |
        | `maxPreviousTracks`                            | [number](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number)     | The maximum number of previous tracks to store. Defaults to 20.                              |     <i className="fa-solid fa-check"/>      |
        ...
        | `trackPartial`                                 | [`TrackPartial[]`](../Enums/TrackPartial.mdx)                                                         | An array of track properties to keep. `track` will always be present.                        |     <i className="fa-solid fa-check"/>      |
        | `useNode`                                      | [`UseNodeOptions`](../Enums/UseNodeOptions.mdx)                                                       | Use the least amount of players or least load? Defaults to Least players.                    |     <i className="fa-solid fa-check"/>      |
        | `enablePriorityMode`                           | [boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean)   | Enable priority mode over least player count or load balancing?                              |     <i className="fa-solid fa-check"/>      |
        ...
        <Tabs>
            <TabItem value="Parameters" label="Parameters" default>
                ...
                > | :--------------------------------------------- | :------------------------------------------------------------------------------------------------ | :-------------------------------------------- |
                > | `packet`                                       | [`DiscordPacket`](../Typedefs/Manager/DiscordPacket)                                              | The payload to send                           |
