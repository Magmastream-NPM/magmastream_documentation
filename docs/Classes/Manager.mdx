...
<Tabs>
    <TabItem value="manager" label="Manager : options" default>
        ...
        | `autoPlaySearchPlatforms`                      | [ `SearchPlatform[]`](../Enums/SearchPlatform.mdx)          | An array of search platforms. Fallback to YouTube if not found.                         |     <i className="fa-solid fa-check"/>      |
